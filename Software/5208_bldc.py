...
# m.setpar('motor.conf1.enccountperrev', 65532)
# m.setpar('motor.conf1.enc2rad', 2*np.pi/65532)
...
#%%
signals = [ 's1.encoderPos1','s1.thetaPark_enc','s1.thetaPark_obs', 's1.BEMFa', 's1.BEMFb']
m.setTrace(signals)
...
ax2 = ax1.twinx()
df.filter(regex='thetaPark').plot(ax=ax2)
